export function CubePlaceholder() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-4">
      <div className="relative">
        ...
        <div className="relative h-12 w-12">
          ...
          <div className="absolute inset-0 rounded-xl border-2 border-transparent border-t-cyan-300/80 border-r-fuchsia-300/80 animate-spin" style={{ animationDuration: "1.2s" }} />
        </div>
      </div>
